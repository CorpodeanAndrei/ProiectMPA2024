...
namespace ProiectMPA.Controllers
{
    public class RolesController : Controller
    {
        ...
        public async Task<IActionResult> AssignRoleToUser(string roleId)
        {
            ...
            var members = new List<UserRoleAssignmentViewModel>();
            var nonMembers = new List<UserRoleAssignmentViewModel>();
        ...
        [HttpPost]
        public async Task<IActionResult> AssignRoleToUser(AssignRolesViewModel model)
        {
            ...
            if (model.NonMemberIds != null)
            {
                foreach (var userId in model.NonMemberIds)
                {
                    var user = await userManager.FindByIdAsync(userId);
                    if (user != null && await userManager.IsInRoleAsync(user, role.Name))
                    {
